...
const Cardamoon = () => {
  React.useEffect(() => {
    document.title = 'Natural, toxin free baby clothes';
  }, []);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const result = await submitWaitlistForm(submissionData, { source: 'cardamoon' });
      if (result.success) {
        if (formData.openToConversation === 'yes') {
          toast.success("You're on the list and you're now part of our founding circle. We'll reach out personally within a few days to set up a quick conversation. As a thank you, you'll get exclusive first-access pricing when Cardamoon launches.", {
            duration: 8000,
          });
        } else {
          toast.success("You're on the list. We'll be in touch when Cardamoon launches.", {
            duration: 5000,
          });
        }
        setFormData({
    ...
    <div className="landing-page">
      ...
      <nav className="nav-container">
        <div className="nav-content">
          <div className="logo">
            <span className="cardamoon-logo-text">
              <span style={{ color: '#1a1a1a' }}>cardam</span><span style={{ color: '#6e9a72' }}>oo</span><span style={{ color: '#1a1a1a' }}>n</span>
            </span>
          </div>
      ...
      <section className="why-section">
        ...
        <div className="stat-cards">
          ...
          <div className="stat-card">
            ...
            <div className="stat-label">toxic treatments in Cardamoon clothing</div>
          </div>
        </div>
      </section>
      ...
      <section className="solution-section">
        ...
        <div className="solution-cards solution-cards-4">
          <div className="solution-card">
            ...
            <p>
              No synthetic dyes, no chemical softeners, no formaldehyde finishes. Nothing that has no business being near a baby's skin. Every Cardamoon garment is free of toxic treatments from the first thread to the last stitch.
            </p>
          </div>
          ...
          <div className="solution-card">
            ...
            <p>
              Infant skin is 30% thinner than adult skin. It doesn't block what touches it — it absorbs it. Your baby is in direct skin contact with clothing all day and through the night. Every Cardamoon decision starts from that fact.
            </p>
          </div>
          ...
          <div className="solution-card">
            ...
            <p>
              Every Cardamoon garment is coloured using plant-based botanicals — each chosen because it carries zero toxic risk against your baby's skin:
            </p>
      ...
      <section id="waitlist" className="waitlist-section">
        <div className="waitlist-container">
          <div className="waitlist-header">
            ...
            <p>We're launching soon. Join the waitlist and we'll be in touch when Cardamoon is ready.</p>
          ...
          <form onSubmit={handleSubmit} className="waitlist-form">
            ...
            <div className="form-group">
              <Label htmlFor="firstImpression">What's your first impression of Cardamoon?</Label>
              <Textarea
                id="firstImpression"
